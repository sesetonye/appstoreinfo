...
- (void)appInfo:(CDVInvokedUrlCommand*)command
{
    ...
    AppVersionCodeModel *model = [AppVersionCodeModel initWithStoreVersion: 0 andLocalVersion: 0];
    ...
    if ([lookup[@"resultCount"] integerValue] == 1){
        ...
        model = [AppVersionCodeModel initWithStoreVersion: appStoreVersionCode andLocalVersion: localVersionCode];
